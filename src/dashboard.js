...
d3.json("data/vcdb.json", function(datos){
    ...
    // Actualiza las visualizaciones en funcion de los valores que se elijan en barra de navegacion
    ...
    function updateData(country, year) {
        ...
        if (country == "All" && year == "All"){
            ...
            var updatedIndustries = datos.map(function(d) { return d.victim.industry; });
            ...
            drawSunburst(updatedDatasetSunburstActions, svgSunburstActions, sunburstWidth, sunburstHeight, trailActions, explanationActions, percentageActions, nodeNamesActions, colorScaleActions);
            
            var updatedActors = datos.map(function(d) {  return d.actor; });
            var updatedDatasetSunburstActors = prepareSunburst(updatedActors);
            drawSunburst(updatedDatasetSunburstActors, svgSunburstActors, sunburstWidth, sunburstHeight, trailActors, explanationActors, percentageActors, nodeNamesActors, colorScaleActors);
        ...
        // Actualiza las graficas con datos totales de pais y filtrados por año
            ...
            }).map(function(d) { return d.victim.industry; });
            var updatedDatasetBars = prepareData(updatedIndustries, "industries")
            drawBars(svgBars, barChartWidth, barChartHeight, barChartMargin, updatedDatasetBars);
            ...
            drawSunburst(updatedDatasetActions, svgSunburstActions, sunburstWidth, sunburstHeight, trailActions, explanationActions, percentageActions, nodeNamesActions, colorScaleActions);    
            ...
            drawSunburst(updatedDatasetActors, svgSunburstActors, sunburstWidth, sunburstHeight, trailActors, explanationActors, percentageActors, nodeNamesActors, colorScaleActors);
